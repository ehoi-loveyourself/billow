...
class TbConditionRecommend(models.Model):
    condition_recommend_id = models.BigAutoField(primary_key=True)
    ...
    class Meta:
        managed = False
        db_table = 'tb_condition_recommend'
...
class TbProgramOrganization(models.Model):
    ...
    broadcasting_time = models.DateTimeField()
    program = models.ForeignKey(TbProgram, models.DO_NOTHING)
