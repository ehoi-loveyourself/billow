...
public class Organization {
    ...
    @Builder
    public Organization(Long id, String programTitle, String broadcastingDay, String broadcastingTime, String broadcastingStation, String broadcastingType, Program program) {
        this.id = id;
