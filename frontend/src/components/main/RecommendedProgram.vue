...
<h2 style="color:white">지금 방송 중인 프로그램(ON AIR)</h2>
  ...
  <div class="box">
    ...
    <div class="info">
      <h3>효리네 민박</h3>
      <div class="detailbox"><span class="detailbox_design">15+</span><span class="detailbox_design">금 오후7:00</span><span class="detailbox_design">예능</span><span class="detailbox_design">tvN</span></div>
    </div>
  </div>
</div>
    </splide-slide>
  ...
  <div class="box">
    ...
    <div class="info">
      <h3>어차피 톡할거 행복하게</h3>
      <div class="detailbox"><span class="detailbox_design">12+</span><span class="detailbox_design">월,화 오후9:00</span><span class="detailbox_design">드라마</span><span class="detailbox_design">EnA</span></div>
    </div>
  </div>
</div>
    </splide-slide>
