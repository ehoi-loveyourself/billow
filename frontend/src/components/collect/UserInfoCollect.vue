<template>
  ...
  <section>
    <b-row style="margin-bottom: 2%">
      <b-col cols="2" style="text-align: right"> 프로필 </b-col>
    ...
    <b-row style="margin-bottom: 2%">
      <b-col cols="2" style="text-align: right"> 성별 </b-col>
      <b-col cols="10" style="padding-left: 1%">
        <b-row>
          <b-col cols="1">
            <b-form-radio
    ...
    <b-row style="margin-bottom: 2%">
      <b-col cols="2" style="text-align: right"> 연령대 </b-col>
      <b-col cols="10" style="padding-left: 1%">
        <b-form-select
    ...
    <b-row style="margin-bottom: 2%">
      <b-col cols="2" style="text-align: right"> 닉네임 </b-col>
      <b-col cols="10" style="padding-left: 1%">
        <b-form-input
          v-model="nickname"
    ...
    <b-row style="margin-bottom: 2%">
      <b-col cols="2" style="text-align: right"> 지역 </b-col>
      <b-col cols="10" style="padding-left: 1%">
        <b-form-select
    ...
    <b-row style="margin-bottom: 2%">
      <b-col cols="2" style="text-align: right"> 인터넷 서비스 </b-col>
      <b-col cols="10" style="padding-left: 1%">
        <b-form-select
    ...
    <b-row style="margin-bottom: 2%">
      <b-col cols="2" style="text-align: right"> 휴대폰 번호 </b-col>
      <b-col cols="10" style="padding-left: 1%">
        <b-form-input
          v-model="phonenum"
  ...
  <p style="text-align: center">
    <a
      ...
      href="#"
      role="button"
      style="border-radius: 15px; font-size: 20px; padding: 15px; color: black"
      >NEXT</a
    >
  </p>
  <br /><br /><br /><br /><br />
