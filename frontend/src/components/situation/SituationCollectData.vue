<template>
  <SituationCollectLoader v-if="isLoading" />
  <div v-else>
    <header-bar />
    <SecondBar />
    <br />
...
import SituationCollectLoader from "@/components/load/SituationCollectLoader.vue";
...
export default {
  ...
  components: {
    ...
    SecondBar,
    SituationRandom,
    SituationCollectLoader
  },
  computed: {
    ...mapState(["who", "genre", "randomProgram", "userNickName", "isLoading"]),
  },
  async created() {
    await this.getRandomProgram();
  },
  created() {
